...
<section class="home" id="home">
    ...
    <div class="content">
        ...
        <span>Covid-19</span>
        <h3>Take Vaccine , Kill Corona</h3>
    ...
    <div class="image">
        <img src="./images/undraw_medical_research_qg4d.svg" alt="">
    </div>
...
<!--checking sloat section start-->


    <section class="slots" id="slots">

        <div class="content">
            <h1 class="heading">Check here <span>Vaccine Slots</span> Availability</h1>
            ...
            <a href="https://www.cowin.gov.in/#Search-Vaccination-Center" class="btn">check slots</a>
        </div>
    
        <div class="image">
            <img src="./images/vaccination-5502034-removebg-preview.png"  alt="">
        </div>
    
    </section>


<!--checking sloat section end-->
...
<section class="protect" id="protect">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <img src="./images/2010.i309.017_hands in gloves with mask realistic.jpg " alt="">
        ...
        <div class="box">
            <img src="./images/undraw_social_distancing_2g0u.svg" alt="">
...
<section class="prevent" id="prevent">
    ...
    <div class="row">
        ...
        <div class="image">
            <img src="./images/hand-5540120.png" alt="">
        </div>
...
<section class="spread" id="spread" >
    ...
    <div class="image">
        <img src="./images/coronavirus-disease-covid-2019-5060518.jpg" alt="">
    </div>
